...
zp = 15; // number of cells in the z direction (depth) of projection zone
nhp = 25; // number of points in height of section of projection zone
nwp = 25; // number of points in width of section of projection zone
exp = 1.10;
...
zc = 30; // number of cells in the z direction (depth) of charging zone
...
Physical Surface(0) = {14, 15, 16, 17, 18};                   // Inlet
Physical Surface(1) = {1, 2, 3, 4, 5, 6, 7, 8};               // Anterior wall
Physical Surface(2) = {110, 88, 66, 220, 198, 176, 154, 132, 264, 330, 242, 286, 308};  // Back wall
Physical Surface(3) = {402, 389, 364, 427};                   // Pipe wall
Physical Surface(4) = {193, 171, 149, 197, 211, 65, 97, 75, 53, 101, 131, 145};   // Contour surfaces
