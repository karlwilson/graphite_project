...
zp = 5; // number of cells in the z direction (depth) of projection zone
nhp = 9; // number of points in height of section of projection zone
nwp = 9; // number of points in width of section of projection zone
exp = 1.10;
...
nwc = 2; // number of points in the width/height of the square
