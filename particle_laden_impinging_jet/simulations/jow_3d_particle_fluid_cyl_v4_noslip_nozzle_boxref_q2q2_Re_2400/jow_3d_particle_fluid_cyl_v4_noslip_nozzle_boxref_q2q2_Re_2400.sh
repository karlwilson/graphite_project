...
cd $PLIJ_PATH/simulations/jow_3d_particle_fluid_cyl_v4_noslip_nozzle_boxref_q2q2_Re_2400 || exit 1

mpirun $HOME/lethe/inst/bin/lethe-fluid-particles ./jow_3d_particle_fluid_cyl_v4_noslip_nozzle_boxref_q2q2_Re_2400.prm
